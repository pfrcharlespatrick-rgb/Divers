...
|---|---|
| **Choisir** | Le niveau de l'eau donne une fenêtre de tailles ; la teinte réduit la liste. Le résultat dit, pour chaque patron retenu, en quel numéro le monter aujourd'hui. |
...
bouton **Sauvegarder mon coffre (.json)**.
